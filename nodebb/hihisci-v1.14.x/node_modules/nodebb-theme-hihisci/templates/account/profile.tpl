<div class="account">
	...
	<div class="profile row">
		...
		<div class="text-center">
			...
			<a href="{config.relative_path}/groups/{selectedGroup.slug}"><small class="label group-label inline-block"
					style="color:{selectedGroup.textColor};background-color: {selectedGroup.labelColor};">
					<!-- IF selectedGroup.icon --><i class="fa {selectedGroup.icon}"></i>
					<!-- ENDIF selectedGroup.icon -->{selectedGroup.userTitle}</small></a>
	...
	<div style="display: flex;justify-content:space-between; ">
		<div style="display: flex;flex-direction: row;">
			<div style="font-size: medium;font-weight: bolder;">文章</div>
			<div style="font-size: medium;margin-left: 35px;font-weight: bolder;">评论</div>
			<div style="font-size: medium;margin-left: 35px;font-weight: bolder;">群组</div>
		</div>
		<div class="account-stats" style="display:flex;flex-direction: row;">
	...
	<!--//TODO:-->
	<div style="background: pink;">这里是profile.tpl</div>
	...
	<div class="row" style="background: purple;">
		<div class="col-xs-12 hidden">
			...
			<a href="{config.relative_path}/groups/{groups.slug}"><span class="label group-label inline-block"
					style="background-color: {groups.labelColor};">
					<!-- IF groups.icon --><i class="fa {groups.icon}"></i>
					<!-- ENDIF groups.icon -->{groups.userTitle}</span></a>
			{{{end}}}
		</div>
	</div>
	<!-- ENDIF groups.length -->
	...
	<!-- IF ips.length -->
	<div class="row" style="background: palegoldenrod;">
		<div class="col-xs-12 hidden">
	...
	<div class="row" style="background: #FFEEE4;">
