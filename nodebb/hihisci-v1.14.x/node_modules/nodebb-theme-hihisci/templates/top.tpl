...
<div data-widget-area="header">
	<div style="background: pink;">这里是top.tpl</div>
	{{{each widgets.header}}}
	{{widgets.header.html}}
	{{{end}}}
</div>
		...
		<div class="btn-group pull-right <!-- IF !terms.length -->hidden<!-- ENDIF !terms.length -->">
			...
			<ul class="dropdown-menu" role="menu">
				...
				<li role="presentation" class="category">
					<a role="menu-item" href="{config.relative_path}/{terms.url}"><i
							class="fa fa-fw <!-- IF terms.selected -->fa-check<!-- ENDIF terms.selected -->"></i>{terms.name}</a>
				</li>
				{{{end}}}
			</ul>
		</div>
