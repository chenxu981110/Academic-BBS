<div id="widgets" class="row">
	<div class="col-md-7" id="active-widgets">
		<ul class="nav nav-pills">
			<!-- BEGIN templates -->
			<li class="<!-- IF @first -->active<!-- ENDIF @first -->"><a href="#" data-template="{../template}"
					data-toggle="pill">{../template}</a></li>
			<!-- END templates -->
		</ul>
			...
			<div class="panel-body">
				<div class="available-widgets">
					...
					<div class="row">
						<!-- BEGIN availableWidgets -->
						<div class="col-xs-12">
							<div data-widget="{availableWidgets.widget}"
					...
					<div class="btn-group" component="clone">
						<button type="button" class="btn btn-primary"
							component="clone/button">[[admin/extend/widgets:clone-from]] ...</button>
			...
			<div class="panel-body">
				...
				<div class="available-containers">
					<div class="containers">
						<div class="pointer" style="padding: 20px; border: 1px dotted #dedede; margin-bottom: 20px;"
							data-container-html=" ">
						...
						<div class="panel"
							data-container-html='<div class="panel panel-default"><div class="panel-body">\{{body}}</div></div>'>
							<div class="panel-body pointer">
								[[admin/extend/widgets:container.panel]]
							</div>
						</div>
						<div class="panel panel-default pointer"
							data-container-html='<div class="panel panel-default"><div class="panel-heading"><h3 class="panel-title">\{{title}}</h3></div><div class="panel-body">\{{body}}</div></div>'>
							<div class="panel-heading">
						...
						<div class="alert alert-info pointer"
							data-container-html='<div class="alert alert-info">\{{body}}</div>'>
